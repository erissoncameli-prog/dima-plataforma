...
const i18n = {
  pt: {
    ...
    nav: {
      ...
      viagens: 'Viagens', beneficiarios: 'Beneficiários', relatorios: 'Relatórios', mapa: 'Mapa de Entregas', repositorio: 'Repositório', produtos: 'Produtos Entregues', matriz: 'Matriz de Resultados', usuarios: 'Usuários', configuracoes: 'Configurações', dados_sistema: 'Dados do Sistema', banco_dados: 'Armazenamento em Nuvem', sair: 'Sair'
    },
    comum: {
  ...
  en: {
    ...
    nav: {
      ...
      viagens: 'Travel', relatorios: 'Reports', mapa: 'Delivery Map', repositorio: 'Repository', produtos: 'Delivered Products', matriz: 'Results Matrix', usuarios: 'Users', configuracoes: 'Settings', dados_sistema: 'System Data', banco_dados: 'Cloud Storage', sair: 'Sign out'
    },
    comum: {
  ...
  es: {
    ...
    nav: {
      ...
      viagens: 'Viajes', relatorios: 'Informes', mapa: 'Mapa de Entregas', repositorio: 'Repositorio', produtos: 'Productos Entregados', matriz: 'Matriz de Resultados', usuarios: 'Usuarios', configuracoes: 'Configuración', dados_sistema: 'Datos del Sistema', banco_dados: 'Almacenamiento en Nube', sair: 'Salir'
    },
    comum: {
