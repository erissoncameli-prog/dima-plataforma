...
function gerarLayout(tituloPagina, paginaAtiva) {
  ...
  const iconePills = {
    ...
    diagnostico:  { svg: '<path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"/><rect x="9" y="3" width="6" height="4" rx="1"/><path d="m9 14 2 2 4-4"/>', cor: '#86efac', bg: 'rgba(134,239,172,0.22)' },
  ...
  const navItems = [
    ...
    // técnico/consultor só com a permissão 'diagnostico' (temPermissao abaixo)
    { id: 'diagnostico',  href: 'diagnostico.html',  perfis: ['super_admin','coordenacao'] },
    // ── Apoio ────────────────────────────────────────────────
