/* Origem: SIGUC-AC (github.com/erissoncameli-prog/siguc-ac), js/pin-baralho.js,
   copiado sem alteração para manter o mesmo PIN dos apps de campo da SEMA.
   Correção lá → copiar de novo aqui. */
/* ═══════════════════════════════════════════════════════════════
